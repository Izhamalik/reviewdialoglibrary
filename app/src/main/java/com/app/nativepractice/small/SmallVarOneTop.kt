...
import com.app.nativepractice.databinding.ActivitySmallVarOneTopBinding
...
class SmallVarOneTop : AppCompatActivity() {
    lateinit var binding : ActivitySmallVarOneTopBinding
    var small_variant_one_top: NativeAd? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivitySmallVarOneTopBinding.inflate(layoutInflater)
        setContentView(binding.root)
        smallVariantOneTop()
    }

    private fun smallVariantOneTop() {
        binding.apply {
            smallVariantOneTopCl.visibility = View.VISIBLE
            smallVariantOneTop.rootView.apply {
            ...
            if (isOnline()) {
                val adLoader =
                    AdLoader.Builder(
                        ...
                        small_variant_one_top = NativeAd
                        smallVariantOneTop.rootView.apply {
                ...
                smallVariantOneTopCl.visibility = View.INVISIBLE
                smallVariantOneTop.rootView.findViewById<CardView>(R.id.cardAds).visibility = View.INVISIBLE
            }
        }
    }
}
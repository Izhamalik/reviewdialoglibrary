...
import com.app.nativepractice.databinding.ActivityLargeVarTwoTopBinding
...
class LargeVarTwoTop : AppCompatActivity() {
    lateinit var binding : ActivityLargeVarTwoTopBinding
    var large_variant_two_top: NativeAd? = null
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityLargeVarTwoTopBinding.inflate(layoutInflater)
        setContentView(binding.root)
        largeVariantTwoTop()
    }
    private fun largeVariantTwoTop() {
        binding.apply {
            largeVariantTwoTopCl.visibility = View.VISIBLE
            largeVariantTwoTop.rootView.apply {
            ...
            if (isOnline()) {
                val adLoader =
                    AdLoader.Builder(
                        ...
                        large_variant_two_top = NativeAd
                        largeVariantTwoTop.rootView.apply {
                ...
                largeVariantTwoTopCl.visibility = View.INVISIBLE
                largeVariantTwoTop.rootView.findViewById<CardView>(R.id.cardAds).visibility =
                    View.INVISIBLE
            }
        }
    }

...
import com.app.nativepractice.databinding.ActivityLargeVarThreeBottomBinding
...
class LargeVarThreeBottom : AppCompatActivity() {
    lateinit var binding:ActivityLargeVarThreeBottomBinding
    var large_variant_three_bottom: NativeAd? = null
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding= ActivityLargeVarThreeBottomBinding.inflate(layoutInflater)
        setContentView(binding.root)
        largeVariantThreeBottom()
    }
    private fun largeVariantThreeBottom() {
        binding.apply {
            largeVariantThreeBottomCl.visibility = View.VISIBLE
            largeVariantThreeBottom.rootView.apply {
...
//                findViewById<RelativeLayout>(R.id.lrLoading).visibility = View.VISIBLE
            ...
            if (isOnline()) {
                val adLoader =
                    AdLoader.Builder(
                        this@LargeVarThreeBottom,
                        getString(com.app.nativepractice.R.string.ad_native)
                    ).forNativeAd { NativeAd: NativeAd ->
                        large_variant_three_bottom = NativeAd
                        largeVariantThreeBottom.rootView.apply {
                        ...
                        override fun onAdFailedToLoad(loadAdError: LoadAdError) {
                            ...
                            large_variant_three_bottom = null
                            largeVariantThreeBottom.rootView.apply {
                ...
                largeVariantThreeBottomCl.visibility = View.INVISIBLE
                largeVariantThreeBottom.rootView.findViewById<CardView>(R.id.cardAds).visibility =
                    View.INVISIBLE
            }
        }
    }

...
import com.app.nativepractice.databinding.ActivityLargeVarOneBottomBinding
...
class LargeVarOneBottom : AppCompatActivity() {
    lateinit var binding : ActivityLargeVarOneBottomBinding
    var large_variant_one_bottom: NativeAd? = null
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityLargeVarOneBottomBinding.inflate(layoutInflater)
        setContentView(binding.root)
        largeVariantOneBottom()
    }
    private fun largeVariantOneBottom() {
        binding.apply {
            largeVariantOneBottomCl.visibility = View.VISIBLE
            largeVariantOneBottom.rootView.apply {
...
//                findViewById<RelativeLayout>(R.id.lrLoading).visibility = View.VISIBLE
            ...
            if (isOnline()) {
                ...
                largeVariantOneBottomCl.visibility = View.INVISIBLE
                largeVariantOneBottom.rootView.findViewById<CardView>(R.id.cardAds).visibility =
                    View.INVISIBLE
            }
        }
    }

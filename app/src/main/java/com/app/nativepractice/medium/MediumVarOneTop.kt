...
import com.app.nativepractice.databinding.ActivityMediumVarOneTopBinding
...
class MediumVarOneTop : AppCompatActivity() {
    lateinit var binding : ActivityMediumVarOneTopBinding
    var medium_variant_one_top: NativeAd? = null
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityMediumVarOneTopBinding.inflate(layoutInflater)
        setContentView(binding.root)

        mediumVariantOneTop()
    }

    private fun mediumVariantOneTop() {
        binding.apply {
            mediumVariantOneTopCl.visibility = View.VISIBLE
            mediumVariantOneTop.rootView.apply {
...
//                findViewById<RelativeLayout>(R.id.lrLoading).visibility = View.VISIBLE
            ...
            if (isOnline()) {
                ...
                mediumVariantOneTopCl.visibility = View.INVISIBLE
                mediumVariantOneTop.rootView.findViewById<CardView>(R.id.cardAds).visibility =
                    View.INVISIBLE
            }
        }
    }

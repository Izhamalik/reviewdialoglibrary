...
import com.app.nativepractice.databinding.ActivityMediumVarOneBottomBinding
...
class MediumVarOneBottom : AppCompatActivity() {
    lateinit var binding : ActivityMediumVarOneBottomBinding
    var medium_variant_one_bottom: NativeAd? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityMediumVarOneBottomBinding.inflate(layoutInflater)
        setContentView(binding.root)

        mediumVariantOneBottom()
    }
    private fun mediumVariantOneBottom() {
        binding.apply {
            mediumVariantOneBottomCl.visibility = View.VISIBLE
            mediumVariantOneBottom.rootView.apply {
...
//                findViewById<RelativeLayout>(R.id.lrLoading).visibility = View.VISIBLE
            ...
            if (isOnline()) {
                val adLoader =
                    AdLoader.Builder(
                        this@MediumVarOneBottom,
                        getString(com.app.nativepractice.R.string.ad_native)
                    ).forNativeAd { NativeAd: NativeAd ->
                        medium_variant_one_bottom = NativeAd
                        mediumVariantOneBottom.rootView.apply {
                        ...
                        override fun onAdFailedToLoad(loadAdError: LoadAdError) {
                            ...
                            medium_variant_one_bottom = null
                            mediumVariantOneBottom.rootView.apply {
                ...
                mediumVariantOneBottomCl.visibility = View.INVISIBLE
                mediumVariantOneBottom.rootView.findViewById<CardView>(R.id.cardAds).visibility =
                    View.INVISIBLE
            }
        }
    }
